package com.oneTech.Smartbank.controller;


import com.oneTech.Smartbank.dto.SignupRequest;
import com.oneTech.Smartbank.dto.UserDto;
import com.oneTech.Smartbank.services.auth.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<?> signupCustomer(@RequestBody SignupRequest signupRequest){
        if(authService.hasCustomerWithEmail(signupRequest.getEmail())){
            return new ResponseEntity<>("Customer Not created , email already used ",HttpStatus.NOT_ACCEPTABLE);
        }
